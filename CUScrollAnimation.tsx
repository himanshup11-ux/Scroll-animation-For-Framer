// CU Scroll Animation + Announcement Bar — Framer Code Component
//
// One component, one file. The announcement bar (Figma node 219:477) is
// folded in rather than imported, so this pastes into Framer as-is.
//
// The bar's own controls are spread into this component's panel, so
// everything is editable from one place: 1–6 announcements with per-item
// CTA copy/link, arrows, auto-rotate, the Figma Glass parameters, and the
// scroll-linked exit across frames 90–110.
...
// ══ Announcement bar ══════════════════════════════════════════════════
//
// Figma node 219:477 (Chandigarh University Website New). Exact geometry
// from the design — bar 684x53 at the reference copy length, laid out as
//   8 pad | 32 arrow | 16 | copy | 16 | CTA | 4 | 32 arrow | 8 pad
// with row height 37, radius 30, CTA #ff3b4d, copy 18px at 90% white.
//
// AnnouncementBarView is exported only for the local preview harnesses.
// The paste-file generator strips that keyword so Framer lists exactly one
// component; everything else here stays internal.
